...
$link = new PDO('mysql:host=localhost;dbname=id17917205_roux', 'id17917205_root', 'Hol&123456789'); // el campo vaciío es para la password. 
...
<body>
    <div class="contenido">
        ...
        <?php foreach ($link->query('SELECT * from artistas') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
        <tr>
